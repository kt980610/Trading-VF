...
# The live engine sizes positions as ``total_equity * weight``; this string is
# the contract the Rust sizing engine validates before opening any position.
...
def build_payload(
    ...
    return {
        ...
        # Canonical sizing contract consumed by the Rust live engine.
        "weights": weights_map,
        "selected_symbols": selected_symbols,
        "weight_semantics": WEIGHT_SEMANTICS,
        "portfolio_version": str(config.portfolio_version),
    }
